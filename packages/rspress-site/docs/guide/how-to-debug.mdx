...
本仓库使用的是 React 19 开发版本，对应的 commit 为 [feat: expose installHook with settings argument from react-devtools-core/backend](https://github.com/facebook/react/commit/a86afe8e560f452a9df5ceb4893d9423e5840800)。
