...
:::tip
本仓库使用的是 React v19.2.4 版本，对应的 tag 为 [v19.2.4](https://github.com/facebook/react/tree/v19.2.4)。
:::
...
```bash
git clone https://github.com/facebook/react.git --branch v19.2.4 --depth 1
```
...
React 19.2.4 源码使用了新的 Flow 语法特性（如 `component()` 类型），当前 @babel/parser 暂不支持。需要做以下处理：
